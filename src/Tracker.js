...
class CalorieTracker {
  ...
  _displayCaloriesLimit() {
    const displayLimitElement = (document.getElementById(
      "calories-limit"
    ).innerHTML = this._calorieLimit);
  }

  _displayCaloriesTotal() {
    const displayCaloriesElement = (document.getElementById(
      "calories-total"
  ...
  _displayNewWorkout(workout) {
    const workoutElement = document.getElementById("workout-items");
    ...
    workoutEl.innerHTML = `<div class="card-body">
        ...
        `;
    workoutElement.appendChild(workoutEl);
  }
